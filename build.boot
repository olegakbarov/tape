...
(set-env!
  ...
  :dependencies
    '[[org.clojure/clojure "1.9.0-alpha16"]
      ...
      [tolitius/boot-check "0.1.6" :scope "test"] [klang "0.5.13" :scope "test"]
      [cljs-http "0.1.44"] [compact-uuids "0.2.0"] [mount "0.1.11"]
      [com.andrewmcveigh/cljs-time "0.5.0"] [reagent "0.8.0-alpha2"] ; [reagent
                                                                     ; "0.8.0-alpha2"
                                                                     ; :exclusions
                                                                     ; [cljsjs.react]]
      ; [cljsjs/react "16.0.0-0"]
      ; [cljsjs/react-dom "16.0.0-0"]
      [cljsjs/moment "2.10.6-0"] [cljsjs/react-motion "0.5.0-0"]
      [cljsjs/chartjs "2.6.0-0"] ; [cljsjs/classnames "2.2.3-0"]
